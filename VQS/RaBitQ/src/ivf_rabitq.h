...
void IVFRN<D, B>::scan(ResultHeap &KNNs, float &distK, uint32_t k, \
    ...
    for(int i=0;i<it;i++){   
        ...
        for(int j=0;j<SIZE;j++){
            ...
            // for (int i=0 ;i<2; i++){
            //     std::cout <<ptr_binary_code[i]<< std::endl;
            // }
            // std::cout << "factor_ip: " << ptr_fac->factor_ip << std::endl;
            // std::cout << "sqr_x: " << ptr_fac->sqr_x << std::endl;
            // std::cout << "sqr_y: " << sqr_y << std::endl;
            // std::cout << "factor_ppc: " << ptr_fac->factor_ppc << std::endl;
            // std::cout << "vl: " << vl << std::endl;
            // std::cout << "ip_byte_bin: " << space.ip_byte_bin(quant_query, ptr_binary_code) << std::endl;
            // std::cout << "sumq: " << sumq << std::endl;
            // std::cout << "width" << width << std::endl;
            // std::cout << "tmp_dist: " << tmp_dist << std::endl;
            // std::cout << "error_bound" << error_bound << std::endl;
            std::cout << *id <<": " << tmp_dist - error_bound << std::endl;
    ...
    //             if(KNNs.size() > k) KNNs.pop();
    //             if(KNNs.size() == k)distK = KNNs.top().first;
    //             std::cout << "gt_dist: " << gt_dist << std::endl;
    //         }
    //     }
    //     std::cout << *id <<": " << *ptr_res << std::endl;
    //     data += D;
